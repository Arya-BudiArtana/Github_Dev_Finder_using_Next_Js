...
const UserData = ({location, twitterUsername, blog, company} : UserDataProps) => {
  return (
    <div className="grid grid-cols-1 gap-6 px-2 py-4 md:grid-cols-2 md:gap-x-10">
          <div className="flex items-center  space-x-2 font-semibold text-white transition-colors duration-150 hover:text-blue-400">
            <MapPinIcon className="h-5 w-5 text-slate-500  dark:text-gray-100" />
          ...
          <div className="flex items-center  space-x-2 font-semibold text-white transition-colors duration-150 hover:text-blue-400">
            <BuildingOffice2Icon className="h-5 w-5 text-slate-500 dark:text-gray-100 " />
